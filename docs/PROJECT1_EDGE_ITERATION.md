...
- The cyborg promotion batch now requires a matching positive dry-run shadow result before it starts spending. A replay-only paper candidate cannot start funded live loops by itself.
